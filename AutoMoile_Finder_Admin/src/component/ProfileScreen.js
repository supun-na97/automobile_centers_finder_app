        ...
        <View style={Styles.tView}>
            ...
            <View style={Styles.textInputView}>
              <TextInput
                ...
                value={this.props.customerData[0].name}
                onChangeText={text => {
          ...
          {/* ----------------------------------------------------- */}
          <View style={Styles.tView}>
            <Text allowFontScaling={false} style={Styles.tagTxt}>ADDRESS ONE</Text>
            <View style={Styles.textInputView}>
              <TextInput
                style={Styles.tInput}
                allowFontScaling={false}
                ...
                underlineColorAndroid="transparent"
                placeholderTextColor="gray"
                value={this.props.customerData[0].address_1}
                onChangeText={text => {
          ...
          {/* ----------------------------------------------------- */}
          <View style={Styles.tView}>
            <Text allowFontScaling={false} style={Styles.tagTxt}>ADDRESS TWO</Text>
            <View style={Styles.textInputView}>
              <TextInput
                style={Styles.tInput}
                allowFontScaling={false}
                ...
                underlineColorAndroid="transparent"
                placeholderTextColor="gray"
                value={this.props.customerData[0].address_2}
                onChangeText={text => {
          ...
          <View style={Styles.tView}>
            ...
            <View style={Styles.textInputView}>
              <TextInput
                ...
                underlineColorAndroid="transparent"
                placeholderTextColor="gray"
                value={this.props.customerData[0].mobile_number}
                onChangeText={text => {
                  //this.props.getCustomerContactNumber(text);
                }}
              />
