      ...
      <View
        ...
        <View
          ...
          <Text
            ...
            {moment(new Date(item.approved_date)).format('YYYY-MM-DD')}
          </Text>
          <Text
            allowFontScaling={false}
            style={{
            ...
            {moment(new Date(item.approved_date)).format('hh:mm a')}
          </Text>
        </View>
        {this.state.today ===
        ...
        <View
          ...
          <TouchableOpacity
            onPress={()=> {
              ...
              this.props.cancelRequest(obj,this.props.userToken);
            }}
            style={{
              width: wp(20),
              height: hp(4),
