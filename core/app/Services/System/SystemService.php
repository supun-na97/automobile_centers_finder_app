...
class SystemService
{
    ...
    public function createUserRequest($request)
    {
        ...
        if (!is_null($customerDetails) && !is_null($companyDetails)) {
            ...
            $companyAddress = $companyDetails->address_1 . ',' . $companyDetails->address_2 . ',' . $companyDetails->address_2 ?? "" ;
            ...
            $this->notificationService->createNotification($companyId, $message, $requestId);
